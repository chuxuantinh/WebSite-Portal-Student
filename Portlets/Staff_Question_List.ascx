<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Staff_Question_List.ascx.cs" Inherits="Portlets_Staff_Question_List" %>
<style type="text/css">
    .auto-style1 {
        color: #FF0000;
    }
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" Width="100%" AllowPaging="True" OnPageIndexChanged="GridView1_PageIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5" AutoGenerateSelectButton="True">
    <Columns>
